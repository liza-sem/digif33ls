  ...
  var ospindrag = document.querySelector('#featured .summary-item-list');
  ...
  var dragArea = document.querySelector('#featured');
  ...
  const headerTextElement = document.querySelector('#featured h1');
